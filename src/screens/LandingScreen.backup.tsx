// src/screens/LandingScreen.tsx - WEB FIXED VERSION
// Fixes: "Text node cannot be a child of <View>" error
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        <View style={styles.navbarContent}>
          ...
          <View style={styles.navLogo}>
            ...
            <Text style={styles.navLogoText}>AgriLogistics</Text>
          </View>
      ...
      <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Animated.View style={[styles.heroContent, Platform.OS !== 'web' && { opacity: fadeAnim }]}>
            {/* Hero Badge */}
            <View style={styles.heroBadge}>
              <Ionicons name="star" size={12} color="#FCBF49" />
            ...
            <View style={styles.heroButtons}>
              ...
              >
                ...
                <Ionicons name="arrow-forward" size={20} color="#2D6A4F" />
              </TouchableOpacity>
              <TouchableOpacity
