...
const styles = StyleSheet.create({
  ...
  hero: {
    minHeight: width > 768 ? height : (width < 375 ? 550 : 600),
    position: 'relative',
    overflow: 'hidden',
  },
  heroBackground: {
  ...
  heroContainer: {
    ...
    paddingHorizontal: width > 768 ? 60 : (width < 375 ? 16 : 20),
    paddingTop: Platform.OS === 'ios' ? 120 : 100,
    paddingBottom: width < 375 ? 30 : 40,
    alignItems: 'center',
    gap: width > 768 ? 40 : 20,
  },
  heroLeftContent: {
  ...
  modernHeroTitle: {
    fontSize: width > 768 ? 52 : (width < 375 ? 28 : 32),
    fontWeight: '800',
    lineHeight: width > 768 ? 62 : (width < 375 ? 36 : 40),
    color: '#FFFFFF',
    marginBottom: width < 375 ? 12 : 16,
    letterSpacing: -1,
  },
  modernHeroSubtitle: {
    fontSize: width > 768 ? 18 : (width < 375 ? 14 : 15),
    lineHeight: width > 768 ? 28 : (width < 375 ? 20 : 22),
    color: '#FFFFFF',
  ...
  modernCTAButton: {
    ...
    paddingHorizontal: width < 375 ? 20 : 24,
    paddingVertical: width < 375 ? 12 : 14,
    borderRadius: 8,
    alignSelf: width < 375 ? 'stretch' : 'flex-start',
    shadowColor: '#6366F1',
  ...
  modernCTAText: {
    ...
    fontWeight: '600',
    color: '#FFFFFF',
    textAlign: width < 375 ? 'center' : 'left',
  },
  trustIndicators: {
    flexDirection: 'column',
    gap: 8,
  ...
  modernServicesSection: {
    paddingVertical: width > 768 ? 80 : (width < 375 ? 40 : 50),
    paddingHorizontal: width > 768 ? 60 : (width < 375 ? 16 : 20),
    backgroundColor: '#FFFFFF',
  },
  modernSectionHeader: {
    alignItems: 'center',
    marginBottom: width > 768 ? 56 : (width < 375 ? 32 : 40),
  },
  modernSectionTitle: {
    fontSize: width > 768 ? 42 : (width < 375 ? 24 : 28),
    fontWeight: '800',
    color: '#1a1a1a',
  ...
  modernSectionSubtitle: {
    ...
    paddingHorizontal: width < 375 ? 8 : 0,
  },
  servicesGrid: {
    flexDirection: width > 768 ? 'row' : 'column',
    gap: width < 375 ? 16 : 20,
  ...
  modernServiceCard: {
    ...
    backgroundColor: '#ffffff',
    borderRadius: 16,
    padding: width > 768 ? 32 : (width < 375 ? 20 : 24),
    alignItems: 'center',
    borderWidth: 1,
    borderColor: '#e2e8f0',
    shadowColor: '#000',
  ...
  modernRoleCard: {
    ...
    backgroundColor: '#ffffff',
    borderRadius: 20,
    padding: width > 768 ? 40 : (width < 375 ? 20 : 28),
  ...
  modernTestimonialCard: {
    ...
    backgroundColor: '#ffffff',
    borderRadius: 16,
    padding: width > 768 ? 28 : (width < 375 ? 16 : 20),
    borderWidth: 1,
    borderColor: '#e2e8f0',
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
  ...
  modernStepIconContainer: {
    marginBottom: width > 768 ? 0 : (width < 375 ? 4 : 8),
  },
  modernStepIcon: {
    width: width < 375 ? 56 : 72,
    height: width < 375 ? 56 : 72,
    borderRadius: width < 375 ? 28 : 36,
    alignItems: 'center',
    justifyContent: 'center',
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 4 },
  ...
  modernCTAContainer: {
    ...
    backgroundColor: '#6366F1',
    borderRadius: 24,
    padding: width > 768 ? 60 : (width < 375 ? 24 : 32),
    maxWidth: 800,
    marginHorizontal: 'auto',
    width: '100%',
  },
  ...
  modernCTAIconBg: {
    width: width < 375 ? 64 : 80,
    height: width < 375 ? 64 : 80,
    borderRadius: width < 375 ? 32 : 40,
    backgroundColor: 'rgba(255, 255, 255, 0.2)',
    alignItems: 'center',
    justifyContent: 'center',
  },
  modernCTATitle: {
    fontSize: width > 768 ? 36 : (width < 375 ? 22 : 26),
    fontWeight: '800',
    color: '#FFFFFF',
    textAlign: 'center',
    marginBottom: width < 375 ? 12 : 16,
    lineHeight: width > 768 ? 44 : (width < 375 ? 28 : 32),
    paddingHorizontal: width < 375 ? 8 : 0,
  },
  modernCTASubtitle: {
    fontSize: width > 768 ? 18 : (width < 375 ? 14 : 15),
  ...
  modernCTAPrimaryButton: {
    ...
    paddingVertical: width < 375 ? 12 : 16,
    borderRadius: 10,
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.2,
  ...
  // Footer
  footer: {
    paddingVertical: width < 375 ? 32 : 40,
  ...
  footerLinksGrid: {
    ...
    justifyContent: 'space-between',
    gap: width < 375 ? 12 : 16,
    flexWrap: width < 375 ? 'wrap' : 'nowrap',
  },
  footerColumn: {
    flex: width < 375 ? undefined : 1,
    gap: width < 375 ? 8 : 12,
    minWidth: width < 375 ? '30%' : undefined,
  },
  footerColumnTitle: {
    fontSize: width < 375 ? 12 : 14,
    fontWeight: '700',
